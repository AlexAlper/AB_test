...
def get_info(id_test, date_begin, date_end, week=False, number_list=None):
    ...
    if id_test == 'all_numbers':
        df_all['date_view'] = df_all['date'].apply(lambda x: str(x)[:10])
...
if __name__=='__main__':
    ...
    # print(get_info("4 adsasd",date_begin, date_end, week=True, number_list=numbers_len))
    # print(get_info("all_numbers",date_begin, date_end))
    # print(get_info("all_numbers",date_begin, date_end, week=True, number_list=numbers_len))
    print(body.top_query(date_begin,date_end,numbers_len))
    print(datetime.now())
